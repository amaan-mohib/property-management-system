...
INSERT INTO `Properties` VALUES (2,'Sain Oasis','Bangalore',10000000.00,3,4,'A beautiful property','https://images.pexels.com/photos/3288102/pexels-photo-3288102.png?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940'),(3,'P1','Bangalore',123.00,3,NULL,'',''),(4,'P2','Ranchi',1000000.00,3,4,'ABC','https://images.pexels.com/photos/106399/pexels-photo-106399.jpeg?cs=srgb&dl=pexels-binyamin-mellish-106399.jpg&fm=jpg'),(5,'Ashok Heritage','Bangalore',10000000.00,3,NULL,'','https://images.pexels.com/photos/87223/pexels-photo-87223.jpeg?cs=srgb&dl=pexels-timur-saglambilek-87223.jpg&fm=jpg');
...
INSERT INTO `Registrations` VALUES (1,'2022-01-27 00:00:00','2032-01-25 00:00:00',2,'Approved',4),(2,'2022-01-28 00:00:00','2032-01-26 00:00:00',4,'Approved',4);
...
INSERT INTO `Users` VALUES (3,'Amaan Mohib','$2a$10$Q.P4rN3YGktkNQAH3syaB./JXY.kStP1hL3uvyqw0/DkOOeb4KFca','2022-01-18','amaan.mohib@gmail.com'),(4,'Amay','$2a$10$hAcyc4Z8zSzcqVZoAU7K7eKYCA4PGuusEUEXy78AsvYhcB6ocN4vm','2022-01-21','amay@gmail.com');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Users Address';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Users Phone';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-01-28 15:16:50
